...
--select soc from res where month='201809' group by soc order by soc desc

--select soc from analytics.abt_stock_report where month='201809';
select 
--count(*)
--* 
'SQL' as src, month, product_id, product_line, product_group, product_subgroup, product_desc, soc, budget_product, 
closing_stock, activations, product_change_to, product_change_from, migration_netto, annulments, activations_annulments, churn_excl_annulments
from res
where
res.month='201809' and
--soc='4EF'
soc='BBINPC2'
...
select 
--*
'STOCK' as src, month, product_id, product_line, product_group, product_subgroup, product_desc, soc, 'BUDGET_PRODUCT' as budget_product,
closing_stock, activations, product_change_to, product_change_from, migration_netto, annulments, activations_minus_annulments, churn_excl_annulments
...
soc='BBINPC2'
 -- 13.335
;
select count(*) from analytics.abt_stock_report where month='201809'
;
